...
export type SignUpSuccess = ActionWithPayload<USER_ACTIONS_TYPES.SIGN_UP_SUCCESS, { user: UserData, additionalDetails: AdditionalInformation }>
...
export const signInSuccess = withMatcher((user: UserData): SignInSuccess => createActions(USER_ACTIONS_TYPES.SIGN_IN_SUCCESS, user))
...
export const signUpSuccess = withMatcher((user: UserData, additionalDetails: AdditionalInformation): SignUpSuccess => createActions(USER_ACTIONS_TYPES.SIGN_UP_SUCCESS, { user, additionalDetails }))
